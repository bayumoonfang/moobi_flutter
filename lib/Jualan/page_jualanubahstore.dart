...
class JualanUbahStore extends StatefulWidget{
  final String getEmail;
  final String getLegalCode;
  final String getWarehouseId;
  const JualanUbahStore(this.getEmail, this.getLegalCode, this.getWarehouseId);
  _JualanUbahStore createState() => _JualanUbahStore();
}


class _JualanUbahStore extends State<JualanUbahStore> {
  List data;
  ...
  String getMessage;
  void changeStore(String valIDOutlet) async {
    final response = await http.post(applink+"api_model.php?act=action_changestore_sales",
        body: {
          "idOutlet":valIDOutlet,
          "getUser":widget.getEmail,
          "getBranch":widget.getLegalCode,
          "getWarehouseId":widget.getWarehouseId
        },
        headers: {"Accept":"application/json"});
