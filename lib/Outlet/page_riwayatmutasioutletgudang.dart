...
class RiwayatMutasiOutletGudang extends StatefulWidget{
  final String getEmail;
  final String getLegalId;
  final String kodeGudang;
  final String idOutlet;

  const RiwayatMutasiOutletGudang(this.getEmail, this.getLegalId,this.kodeGudang, this.idOutlet);
  @override
  _RiwayatMutasiOutletGudang createState() => _RiwayatMutasiOutletGudang();
}


class _RiwayatMutasiOutletGudang extends State<RiwayatMutasiOutletGudang> {
                                                          ...
                                                          Padding(
                                                            ...
                                                            child : Align(alignment: Alignment.centerLeft, child: Text(
                                                              ...
                                                              : snapshot.data[i]["c"].toString().substring(0,2) == 'BB' ?
                                                                  ...
                                                                  : snapshot.data[i]["c"].toString() == 'ds' ?
                                                              snapshot.data[i]["l"]+" "+snapshot.data[i]["m"]+" "+snapshot.data[i]["j"]+ " - (DELETE STOCK)"
                                                              :
