...
class OutletProduk extends StatefulWidget{
  ...
  const OutletProduk(this.getEmail, this.getLegalCode, this.getNamaUser, this.getidOutlet);
  @override
  _OutletProduk createState() => _OutletProduk();
}


class _OutletProduk extends State<OutletProduk> {
  List data;
      ...
      child: Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
              onPressed: (){
                FocusScope.of(context).requestFocus(FocusNode());
               Navigator.push(context, MaterialPageRoute(builder: (context) => TambahProdukOutlet(widget.getidOutlet, widget.getEmail,  widget.getLegalCode, widget.getNamaUser)));
