...
import 'package:moobi_flutter/Outlet/page_tambahprodukgudangoutlet.dart';
...
class GudangOutletProduk extends StatefulWidget{
  ...
  const GudangOutletProduk(this.idGudang, this.kodeGudang, this.getEmail, this.getLegalCode, this.getNamaUser,this.getIdOutlet);
  @override
  _GudangOutletProduk createState() => _GudangOutletProduk();
}


class _GudangOutletProduk extends State<GudangOutletProduk> {
  List data;
  ...
  _doHapus (String valueParse2) async {
    final response = await http.get(applink+"api_model.php?act=action_hapusgudangproduk&id="+valueParse2.toString()
      ...
      child: Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
              onPressed: (){
                FocusScope.of(context).requestFocus(FocusNode());
                Navigator.push(context, MaterialPageRoute(builder: (context) => TambahProdukGudangOutlet(
                    widget.kodeGudang, widget.getEmail,  widget.getLegalCode, widget.getNamaUser,
                widget.getIdOutlet)));
