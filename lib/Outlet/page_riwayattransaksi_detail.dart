...
class _RiwayatTransaksiDetail extends State<RiwayatTransaksiDetail> {
  ...
  _getDetailPayment() async {
    final response = await http.get(applink+"api_model.php?act=getdata_transaksicust_detail&id="+widget.idPayment);
  ...
  Future<List> getData() async {
    http.Response response = await http.get(
        Uri.encodeFull(applink+"api_model.php?act=getdata_listproduktransaksi&"
            "sonumber="+getSoNumber.toString()+"&branch="+widget.getLegalCode),
        headers: {"Accept":"application/json"});
